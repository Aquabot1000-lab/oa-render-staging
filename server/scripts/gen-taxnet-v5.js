...
const clients = [
  {
    ...
    comps: [
      { tid: 'R-13273-00J-0250-1', addr: '740 SANTA LUCIA DR', mv: 359000, dist: 0.05, cls: 'A1', cond: 'Good', yb: '2024', ey: '2024', sqft: 1777, iv: 234000, fv: 0, pv: 0, lv: 125000 },
      { tid: 'R-13273-00K-0010-1', addr: '901 PORTINA DR', mv: 367500, dist: 0.16, cls: 'A1', cond: 'Good', yb: '2024', ey: '2024', sqft: 1777, iv: 242500, fv: 0, pv: 0, lv: 125000 },
      { tid: 'R-13273-00K-0040-1', addr: '924 AMENDUNI LN', mv: 367900, dist: 0.20, cls: 'A1', cond: 'Good', yb: '2024', ey: '2024', sqft: 1777, iv: 242900, fv: 0, pv: 0, lv: 125000 },
      { tid: 'R-13273-00J-0070-1', addr: '221 SANTA LUCIA DR', mv: 375000, dist: 0.17, cls: 'A1', cond: 'Good', yb: '2023', ey: '2023', sqft: 1799, iv: 249000, fv: 0, pv: 0, lv: 126000 },
      { tid: 'R-13273-00L-0050-1', addr: '1309 RENATO DR', mv: 375000, dist: 0.24, cls: 'A1', cond: 'Good', yb: '2024', ey: '2024', sqft: 1799, iv: 249000, fv: 0, pv: 0, lv: 126000 },
      { tid: 'R-13273-00F-0120-1', addr: '601 PEMBERTON DR', mv: 349995, dist: 0.25, cls: 'A1', cond: 'Good', yb: '2018', ey: '2018', sqft: 1842, iv: 223995, fv: 0, pv: 0, lv: 126000 },
      { tid: 'R-13273-00H-0080-1', addr: '1988 HELMOKEN FALLS DR', mv: 310000, dist: 0.38, cls: 'A1', cond: 'Good', yb: '2005', ey: '2005', sqft: 1787, iv: 185000, fv: 0, pv: 0, lv: 125000 },
      { tid: 'R-13273-00C-0030-1', addr: '132 BIRDBROOK DR', mv: 317000, dist: 0.45, cls: 'A1', cond: 'Good', yb: '2006', ey: '2006', sqft: 1782, iv: 192000, fv: 0, pv: 0, lv: 125000 },
      { tid: 'R-13273-00E-0100-1', addr: '910 FULBOURNE DR', mv: 315000, dist: 0.53, cls: 'A1', cond: 'Good', yb: '2007', ey: '2007', sqft: 1760, iv: 190000, fv: 0, pv: 0, lv: 125000 },
      { tid: 'R-13273-00L-0040-1', addr: '1216 RENATO DR', mv: 420000, dist: 0.26, cls: 'A1', cond: 'Good', yb: '2024', ey: '2024', sqft: 1800, iv: 294000, fv: 0, pv: 0, lv: 126000 },
    ]
  },
  {
    ...
    comps: [
      { tid: '5296-09-002-0140-901', addr: '3202 MARLENE MEADOW WAY', mv: 739900, dist: 0.11, cls: 'A1', cond: 'Good', yb: '2023', ey: '2023', sqft: 3717, iv: 676850, fv: 0, pv: 0, lv: 63050 },
      { tid: '5296-09-001-0080-901', addr: '3306 WILLOW FIN WAY', mv: 645000, dist: 0.17, cls: 'A1', cond: 'Good', yb: '2022', ey: '2022', sqft: 3741, iv: 581950, fv: 0, pv: 0, lv: 63050 },
      { tid: '5296-09-002-0170-901', addr: '3215 MARLENE MEADOW WAY', mv: 630000, dist: 0.09, cls: 'A1', cond: 'Good', yb: '2023', ey: '2023', sqft: 3794, iv: 566950, fv: 0, pv: 0, lv: 63050 },
      { tid: '5296-05-001-0120-901', addr: '2111 S PECAN TRAIL DR', mv: 574000, dist: 1.26, cls: 'A1', cond: 'Good', yb: '2002', ey: '2002', sqft: 3866, iv: 510950, fv: 0, pv: 0, lv: 63050 },
      { tid: '5296-08-003-0050-901', addr: '4119 PEMBROOKE WAY', mv: 774999, dist: 1.29, cls: 'A1', cond: 'Good', yb: '2003', ey: '2003', sqft: 3895, iv: 711949, fv: 0, pv: 0, lv: 63050 },
      { tid: '5296-05-001-0080-901', addr: '2015 PECAN TRAIL DR', mv: 499000, dist: 1.35, cls: 'A1', cond: 'Good', yb: '1990', ey: '1990', sqft: 3968, iv: 435950, fv: 0, pv: 0, lv: 63050 },
      { tid: '5296-04-002-0100-901', addr: '2218 LANDSCAPE WAY', mv: 500000, dist: 1.57, cls: 'A1', cond: 'Good', yb: '1989', ey: '1989', sqft: 3269, iv: 436950, fv: 0, pv: 0, lv: 63050 },
      { tid: '5296-06-001-0030-901', addr: '3006 PECAN WAY CT', mv: 625000, dist: 1.05, cls: 'A1', cond: 'Good', yb: '1998', ey: '1998', sqft: 4723, iv: 561950, fv: 0, pv: 0, lv: 63050 },
      { tid: '5296-10-001-0150-901', addr: '8327 VALBURN DR', mv: 464998, dist: 1.49, cls: 'A1', cond: 'Good', yb: '2024', ey: '2024', sqft: 2989, iv: 401948, fv: 0, pv: 0, lv: 63050 },
      { tid: '5296-05-002-0040-901', addr: '2106 SHADE CREST DR', mv: 549000, dist: 1.26, cls: 'A1', cond: 'Good', yb: '1994', ey: '1994', sqft: 4031, iv: 485950, fv: 0, pv: 0, lv: 63050 },
    ]
  }
];

function calcAdj(subj, c) {
  const cpf = c.iv / c.sqft;
  const sz = Math.round(cpf * (subj.mainSqft - c.sqft) / 2);
  const age = Math.round(0.5 * ((parseInt(subj.effectiveYear) - parseInt(c.ey)) / 100) * c.mv);
  const land = subj.landValue - c.lv;
  const feat = subj.featureValue - c.fv;
  const pool = subj.poolValue - c.pv;
  const net = sz + age + land + feat + pool;
  return { sz, age, land, feat, pool, net, total: c.mv + net, psf: cpf };
}
...
function gen(client) {
  return new Promise((resolve, reject) => {
    ...
    const CPP = 3;
    // FIXED column widths — always 4 data columns (subject + 3 comps) regardless of how many comps on page
    const LW = 120; // label width
    const DW = Math.floor((PW - 60 - LW) / 4); // always divide by 4
    ...
    function drawCompPage(pcs) {
      ...
      // 3 comp columns (always 3, even if fewer comps on this page)
