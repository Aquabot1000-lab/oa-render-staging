...
function generateTXForm50162(filing, client, property) {
    return new Promise((resolve, reject) => {
        ...
        doc.fontSize(8).fillColor('#666').text(
            'This form is a representation of Texas Comptroller Form 50-162. Generated by OverAssessed, LLC.',
            { align: 'center' }
        );
...
function generateGAPOA(filing, client, property) {
    return new Promise((resolve, reject) => {
        ...
        doc.moveDown(2);
        doc.fontSize(8).fillColor('#666').text(
            'Generated by OverAssessed, LLC. This document serves as a Letter of Authorization for property tax appeal representation in the State of Georgia.',
            { align: 'center' }
        );
